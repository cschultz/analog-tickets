...
const MayEscape = () => {
  useCanonicalUrl('/escape');

  useEffect(() => {
    trackGA4ViewItem({
      item_id: "analog_reunion_ticket",
      item_name: "Cosmico – Escape Landing",
    ...
    <div className="min-h-screen overflow-hidden" style={{ backgroundColor: COLORS.dustySky }}>
          ...
          >
            ...
            <div className="relative z-10 flex-1 flex flex-col justify-center py-12">
              ...
              <motion.div className="mt-10 md:mt-14 max-w-md" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.6, delay: 0.7 }}>
                <p className="text-sm md:text-base" style={{ ...typography.body, color: COLORS.charcoal, opacity: 0.9, lineHeight: 1.6 }}>
      ...
      <section className="relative min-h-screen" style={{ backgroundColor: COLORS.charcoal }}>
        <div className="grid grid-cols-1 md:grid-cols-2 min-h-screen">
          <TypographyPanel
            label="THE SETTING"
            headline={<>The<br />Russian<br />River.</>}
            bgColor={COLORS.dustySky}
            textColor={COLORS.charcoal}
            labelColor={COLORS.forest}
            footnote="EXAMPLE VALLEY · EXAMPLE COUNTY"
            body={
              <>
                <p style={{ ...typography.body, color: COLORS.charcoal, fontSize: '15px', lineHeight: 1.7, opacity: 0.9 }}>
                  Just outside Example Valley, Cosmico unfolds along the Example River — where mornings start slow, afternoons drift between music and water, and nights glow under the Example Valley sky.
                </p>
              </>
            }
          />
          <DuotonePanel 
            ...
            alt="Golden hour along the Example River" 
            color={COLORS.forest} 
      ...
      <section className="relative min-h-screen" style={{ backgroundColor: COLORS.charcoal }}>
        <div className="grid grid-cols-1 md:grid-cols-2 min-h-screen">
          <DuotonePanel 
            image={handsRaisedBokeh} 
            alt="Hands raised at live music performance" 
            color={COLORS.clay} 
            ...
            body={
              <>
                <div className="space-y-4">
                  {['River swims', 'Sauna sessions', 'Live music all day', 'Late-night sets', 'Artisan market', 'Wine and local food'].map((item) => (
                    <p key={item} style={{ ...typography.headline, color: COLORS.dustySky, fontSize: '16px', textTransform: 'uppercase', lineHeight: 1.3 }}>
                      {item}
                    </p>
                  ))}
                </div>
      ...
      <section className="relative" style={{ backgroundColor: COLORS.dustySky }}>
        ...
        <div className="relative z-10 container mx-auto px-6 md:px-12 py-24 md:py-36">
          <div className="max-w-3xl">
            ...
            >
              Cosmico is intentionally small. Musicians, winemakers, artists, founders, families, and curious humans gather for a weekend designed to bring people together.
            </motion.p>
          </div>
        </div>
      </section>
      ...
      <section className="relative min-h-screen" style={{ backgroundColor: COLORS.charcoal }}>
        <div className="grid grid-cols-1 md:grid-cols-2 min-h-screen">
          <DuotonePanel 
            ...
            alt="On-site glamping at Example Meadow" 
            color={COLORS.forest} 
            secondaryColor={COLORS.sage}
            imageBrightness={1.1}
            colorOpacity={0.4}
          ...
          <TypographyPanel
            label="LODGING"
            headline={<>Stay At<br />The<br />Gathering.</>}
            ...
            body={
              <>
                <p style={{ ...typography.body, color: COLORS.dustySky, fontSize: '15px', lineHeight: 1.7, opacity: 0.9 }}>
                  Stay on-site at Example Meadow with optional glamping just steps from the music.
                </p>
              </>
            }
          >
            <motion.div className="mt-8" initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true }} transition={{ duration: 0.6, delay: 0.5 }}>
              <Link to="/my-tickets" className="inline-block px-6 py-3 text-xs uppercase hover:opacity-80 transition-opacity" style={{
